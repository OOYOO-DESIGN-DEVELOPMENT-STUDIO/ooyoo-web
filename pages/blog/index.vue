...
useHead({
	...
	meta: [
		{
			name: 'description',
			content: "OOYOO's portfolio of brands, products and services.",
		},
	],
...
<template>
	...
	<section class="grid md:grid-cols-3 mt-8 gap-5">
		<Post :posts="posts" />
	</section>
	<ul>
		<li v-for="post in posts" :key="post._id" class="my-8 py-4 border-b-2">
			<nuxt-link :to="post._path" class="text-blue-500 text-2xl"
				>{{ post.title }}
